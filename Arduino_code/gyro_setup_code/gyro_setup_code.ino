...
#include <EEPROM.h>   //Include EEPROM.h library to store the setup information in EEPROM
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  //Get the controller in the rest position
  if(error == 0){
    delay(2000);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Checking which direction the controller sticks are directing
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

  //Check if the throttle stick and the roll stick is functioning in the correct directions
  if(error == 0){  
  ...
  //Check if the pitch stick is in the correct direction
  if(error == 0){
    Serial.println(F(""));
    Serial.println(F(""));
  ...
  //Check if the height controller is functioning in the right direction
  if(error == 0){
    Serial.println(F(""));
    Serial.println(F(""));
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Verifying the max and min values of the controller
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

  //Register the max and min values of each stick
  if(error == 0){
    Serial.println(F(""));
    Serial.println(F(""));
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  //Checking if LED is functioning correctly
  if(error == 0){
    Serial.println(F(""));
    Serial.println(F("==================================================="));
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Final checking for receiver channel and the gyro axies
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Data collection in EEPROM
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

  //When everything is working, collect the data in the EEPROM
  if(error == 0){
    ...
    //To make sure evrything is ok, double-check the EEPROM data.
  ...
  //When this is reached, either everything is done and need to start ESC calibration or there is an error
  if(error == 0){
...
//Starting communication with gyro in case of different types
void start_gyro(){
